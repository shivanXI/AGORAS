...
echo nl2br("YOUR RESPONSE FOR POLITICS CATEGORY IS SUBMITTED!\nYOUR ARE NOW FREE TO USE IT AGAIN!\nSO WHAT ARE YOU WAITING FOR GO ON!!
\n YOU CAN MOVE BACK TO ENJOY YOUR DISCUSSIONS ON AGORAS !!!!!");
if(!($username!="" && $ques!="" && $ans!="" && $comment!="" && $usernameErr =="" && $commentErr == "" && $ansErr == "" && $quesErr==""))
{
$sql = "INSERT INTO  question (Q_Id,Ques,Q_Date,usernameu,Cname) VALUES('','$ques','','$username','politics')";
$res = mysql_query($sql);
$sqll = "INSERT INTO answer (A_Id,Answer,A_Date,usernameu,Cname) VALUES ('','$ans','','$username','politics')";
