...
echo nl2br("YOUR RESPONSE FOR SPORTS CATEGORY IS SUBMITTED!\nYOUR ARE NOW FREE TO USE IT AGAIN!\nSO WHAT ARE YOU WAITING FOR GO ON!!
\n YOU CAN MOVE BACK TO ENJOY YOUR DISCUSSIONS ON AGORAS !!!!!");
if(!($username!="" && $ques!="" && $ans!="" && $comment!="" && $usernameErr =="" && $commentErr == "" && $ansErr == "" && $quesErr==""))
{
echo "hello";
$sql = "INSERT INTO  question (Q_Id,Ques,Q_Date,usernameu,Cname) VALUES('','$ques','','$username','sports')";
$res = mysql_query($sql);
$sqll = "INSERT INTO answer (A_Id,Answer,A_Date,usernameu,Cname) VALUES ('','$ans','','$username','sports')";
