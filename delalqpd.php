<html>
<head>
** QUESTION  DELETED  ACCORDING  TO  YOUR  CHOICE ON DAY ENTERED BY YOU ** 
!! REMAINING QUESTIONS !!
<style>
table
{
...
$result = mysql_query("DELETE FROM question WHERE usernameu = '$userenter' AND Cname = '$usercate' AND Q_Date = '$userdate'"); 
