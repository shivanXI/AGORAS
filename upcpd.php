<html>
<head>
** COMMENT  UPDATED  ACCORDING TO YOUR CHOICE ON DAY ENTERED BY YOU** 
!! UPDATED COMMENTS !!
<style>
table
{
...
$result = mysql_query("UPDATE comment SET COMM ='$usercomm' WHERE usernameu = '$userenter' AND Cname = '$usercate' AND C_DATE = '$userdate'");
